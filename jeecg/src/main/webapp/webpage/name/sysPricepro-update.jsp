 ...
 <body>
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="priName" name="priName" type="text" style="width: 150px" class="inputxt"  value='${sysPriceproPage.priName}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="priPrice" name="priPrice" type="text" style="width: 150px" class="inputxt"  value='${sysPriceproPage.priPrice}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="priCaozuoyuan" name="priCaozuoyuan" type="text" style="width: 150px" class="inputxt"  value='${sysPriceproPage.priCaozuoyuan}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="priDate" name="priDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()" value='<fmt:formatDate value='${sysPriceproPage.priDate}' type="date" pattern="yyyy-MM-dd"/>'>
							<span class="Validform_checktip"></span>
